...
```{r}
ggplot(data, aes(x = income, y = hours.per.week)) +
  geom_violin(trim = TRUE) +
  stat_summary(fun = median, geom = "point", size = 2, color = "black") +
  coord_flip() +
  labs(title = "Violin: hours-per-week por income", x = "Income", y = "Horas por semana") +
  theme_minimal()
...
ggplot(data, aes(x = age)) +
  ...
  facet_wrap(~ income) +
  labs(title = "Distribuição de idade por classe de renda", x = "Idade", y = "Contagem") +
  theme_minimal()
```
